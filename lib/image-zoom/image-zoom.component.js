...
var ImageViewer = function (_React$Component) {
    ...
    _createClass(ImageViewer, [{
        ...
        value: function render() {
            ...
            return React.createElement(react_native_1.View, __assign({ style: [image_zoom_style_1.default.container, { width: this.props.cropWidth, height: this.props.cropHeight }] }, this.imagePanResponder.panHandlers), React.createElement(react_native_1.Animated.View, { style: animateConf }, React.createElement(react_native_1.View, { onLayout: this.handleLayout, style: { width: this.props.imageWidth, height: this.props.imageHeight } }, this.props.children)));
        }
    }]);
